...
public class Test {
  ...
  public static void main(String... args) {
    ...
    Logger.log("Traverse library:");
    boolean traversedAll = new PrintNBooks(library, 8).traverse();
    Logger.log("Traversed all " + traversedAll);
    Logger.log("Traverse catalog:");
    traversedAll = new PrintNBooks(catalog, 2).traverse();
    Logger.log("Traversed all " + traversedAll);

    Logger.log("Traverse library by Author 5:");
    new PrintAuthorBooks(library, "Author 5").traverse();
    Logger.log("Traverse catalog by Author 5:");
