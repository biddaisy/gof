...
**Package Root:** `com.mr.gof.structural`
...
## 1. **Adapter Pattern**
**Package:** `com.mr.gof.structural.adapter`  
...
## 2. **Bridge Pattern**
**Package:** `com.mr.gof.structural.bridge`  
...
## 3. **Composite Pattern**
**Packages:**
- `com.mr.gof.structural.composite.computer`
...
## 4. **Decorator Pattern**
**Package:** `com.mr.gof.structural.decorator`  
...
## 5. **Facade Pattern**
**Package:** `com.mr.gof.structural.facade`  
...
## 6. **Flyweight Pattern**
**Package:** `com.mr.gof.structural.flyweight`  
...
- `com.mr.gof.structural.proxy.bank.grpc`
- `com.mr.gof.structural.proxy.bank.virtual`
- `com.mr.gof.structural.proxy.bank.cache`
