...
public class FunctionComposite implements Function {
  ...
  public String getFunction(String operand) {
    return function1.getFunction(function2.getFunction(operand));
  }

  @Override
  public String getDerivative(String operand) {
    return function1.getDerivative(function2.getFunction(operand)) + "*" + function2.getDerivative(operand);
  }
